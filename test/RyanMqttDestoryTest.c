...
static RyanMqttError_e RyanMqttConnectDestory(uint32_t count, uint32_t delayms)
{
    for (uint32_t i = 0; i < count; i++)
    {
        ...
        RyanMqttPublish(client, "testlinux/pub1", "helloworld", strlen("helloworld"), RyanMqttQos0, RyanMqttFalse);
        RyanMqttPublish(client, "testlinux/pub2", "helloworld", strlen("helloworld"), RyanMqttQos1, RyanMqttFalse);
        RyanMqttPublish(client, "testlinux/pub3", "helloworld", strlen("helloworld"), RyanMqttQos2, RyanMqttFalse);
